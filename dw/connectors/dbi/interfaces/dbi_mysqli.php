...
class dbi_mysqli extends dbiInterface {
	public function connect($shost, $sport, $suser, $spassword, $sdatabase) {
		$this->_reslink = mysqli_connect ( $shost, $suser, $spassword, $sdatabase, ( float ) $sport );
		return $this->_reslink;
	}
	public function pconnect($shost, $sport, $suser, $spassword, $sdatabase) {
		$this->_reslink = mysqli_connect ( "p:".$shost, $suser, $spassword, $sdatabase, ( float ) $sport );
		return $this->_reslink;
	}
	...
	public function query($squery) {
		mysqli_set_charset ( $this->_reslink, "unicode" );
	...
	public function setClientEncoding($encoding) {
		return mysqli_set_charset ( $this->_reslink, $encoding );
	}
	...
	public function equivDwType($columnType) {
		switch (strtoupper ( $columnType )) {
			...
			case "DOUBLE" :
			case "DECIMAL" :
				return DW_FIELD_TYPE_NUMERIC;
			case "DATETIME" :
			case "TIMESTAMP" :
				return DW_FIELD_TYPE_DATETIME;
			case "DATE" :
			case "TIME" :
			case "YEAR" :
				return DW_FIELD_TYPE_DATE;
			case "TEXT" :
			case "TINYBLOB" :
			case "TINYTEXT" :
			case "BLOB" :
